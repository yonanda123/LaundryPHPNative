        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="white-box analytics-info">
                    <a href="outlet.php" class="box-title">
                        <h3 class="box-title">Oulet</h3>
                        <ul class="list-inline two-part">
                            <li>
                                <div class="fa fa-suitcase"></div>
                            </li>
                            <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple"><?= $joutlet['jumlahoutlet'] ?></span></li>
                        </ul>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="white-box analytics-info">
                    <a href="paket.php" class="box-title">
                        <h3 class="box-title">Peket</h3>
                        <ul class="list-inline two-part">
                            <li>
                                <div class="fa fa-archive"></div>
                            </li>
                            <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple"><?= $jpaket['jumlahpaket'] ?></span></li>
                        </ul>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="white-box analytics-info">
                    <a href="pengguna.php" class="box-title">
                        <h3 class="box-title">Pengguna</h3>
                        <ul class="list-inline two-part">
                            <li>
                                <div class="fa fa-user"></div>
                            </li>
                            <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple"><?= $jpengguna['jumlahpengguna'] ?></span></li>
                        </ul>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="white-box analytics-info">
                    <a href="pelanggan.php" class="box-title">
                        <h3 class="box-title">Pelanggan</h3>
                        <ul class="list-inline two-part">
                            <li>
                                <div class="fa fa-users"></div>
                            </li>
                            <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple"><?= $jpelanggan['jumlahpelanggan'] ?></span></li>
                        </ul>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="white-box analytics-info">
                    <a href="transaksi.php" class="box-title">
                        <h3 class="box-title">Transaksi</h3>
                        <ul class="list-inline two-part">
                            <li>
                                <div class="fa fa-shopping-cart"></div>
                            </li>
                            <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple"><?= $jtransaksi['jumlahtransaksi'] ?></span></li>
                        </ul>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-xs-12">
                <div class="white-box analytics-info">
                    <a href="laporan.php" class="box-title">
