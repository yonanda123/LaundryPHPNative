            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="dashboardd.php" class="waves-effect <?php if ($title == 'dashboard') {
                                                                            echo 'active';
                                                                        } ?>"><i class="fa fa-tachometer fa-fw" aria-hidden="true"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="pelanggank.php" class="waves-effect <?php if ($title == 'pelanggan') {
                                                                            echo 'active';
                                                                        } ?>"><i class="fa fa-users fa-fw" aria-hidden="true"></i> Pelanggan</a>
                    </li>
                    <li>
                        <a href="transaksik.php" class="waves-effect <?php if ($title == 'transaksi') {
                                                                            echo 'active';
                                                                        } ?>"><i class="fa fa-shopping-cart fa-fw" aria-hidden="true"></i> Transaksi</a>
                    </li>
                    <li>
                        <a href="laporank.php" class="waves-effect <?php if ($title == 'laporan') {
                                                                        echo 'active';
